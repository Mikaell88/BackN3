...
app.post('/customers', (req, res) => {
    ...
    execSQLQuery('INSERT INTO Clientes(ID, Nome, Email) VALUES(@ID, @Nome, @Email)', [
...
app.get('/customers/:ID', (req, res) => {
    ...
    execSQLQuery('SELECT * FROM Clientes WHERE ID=@id', [
        { name: 'id', type: sql.Int, value: id }
    ], res);
});
...
app.delete('/customers/:id', (req, res) => {
    ...
    execSQLQuery('DELETE FROM Clientes WHERE ID=@id', [
        { name: 'id', type: sql.Int, value: id }
    ], res);
});
...
app.put('/customers/:id', (req, res) => {
    ...
    execSQLQuery('UPDATE Clientes SET Nome=@name, Email=@email WHERE ID=@id', [
        { name: 'id', type: sql.Int, value: id },
